...
import { Container, Box, Card, CardContent, Tabs, Tab, Grid, Divider, Link, AppBar } from '@material-ui/core'
			...
			<Grid item xs={12} sm={6} md={4} style={{padding: 10, minWidth: 300}}>
				...
				> 
					<CardContent style={{padding: 0, height: '250px'}}>
						<img src={`${content.img}`} alt="card index" style={{display: 'block', height: '100%', width: '100%'}} />
